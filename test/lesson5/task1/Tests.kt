...
class Tests {
    ...
    fun flattenPhoneNumber() {
        ...
        assertEquals("", flattenPhoneNumber("+(9323)3232"))
    }
    ...
    fun bestLongJump() {
        ...
        assertEquals(2147483647, bestLongJump("1617100629  % 2147483647    0  2147483647 - - - 1 -  - 2147483647   1 -    2147483647 1 %  - 1723820995 0 2147483647   % 2147483647 1  -  859314962 - 2147483647 - % -   -   -   761279840   - % % -   - 0 1  0 -  - 1898488453 913809020   2147483647  1946082680 - 2072830840    1 % - 1259908393 0 -   %   1394013460   - %  % -  - 2147483647 % 0   - % % 2147483647     % 100931553 -     - 165420336 - - -    - - 1556087209  - 2147483647  - -   - - -    % %    - 1149598617  1  1486940231 0  % - 1  1000257700 - 1 -  1298361731 1929992606 - %  1943347283 797337722 - 1610625879  % 0 0 %  % 1775044754 1479720876 0 -  1329704874  1 - -   1 319026704 - 1   - -  -  1647256523 -   - - -"))
    ...
    fun mostExpensive() {
        ...
        assertEquals("", mostExpensive("Вино 255.0; Молоко -14.3"))
        assertEquals("", mostExpensive("Вино; Молоко 12"))
    }
